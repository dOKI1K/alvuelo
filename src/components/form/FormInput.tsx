    ...
    return (
        <div className="space-y-2">
            ...
            <div className="relative">
                <Input id={name} name={name} type={type} placeholder={placeholder} value={value} className={`border-slate-500 focus-visible:outline-none focus-visible:ring-0 ${icon ? "peer ps-9" : ""}`} onChange={onChange} />
