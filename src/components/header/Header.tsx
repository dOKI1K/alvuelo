...
export default function Header() {
    return (
        <motion.header
            ...
            x-data="{ open: false }"
        >
            <img src={logo} alt="Al Vuelo" className="w-16 md:w-32" />
            ...
            <ul className="flex-row hidden px-2 font-semibold md:flex gap-x-4 font-poppins">
                ...
                <li><a href="#deposit" className="">Deposito</a></li>
                <li><a href="#us" className="">Nosotros</a></li>
                <li><a href="#contact" className="px-4 py-2 text-white transition-colors ease-in-out rounded-md bg-cyan-600">Contacto</a></li>
            </ul>
            <div className="md:hidden">
                <button className="flex items-center justify-center p-2 text-white transition-colors ease-in-out md:hidden" x-on:click="open = ! open">
                    <HiBars3 size={30} />
                </button>
            </div>

            <div x-show="open" className="absolute left-0 flex flex-col items-center justify-center w-full h-screen bg-gray-900 md:hidden top-20 -translate-y-100">
